...
// db['suspected-carloschanta'].aggregate({
//     "$group": {
//         '_id': "$category",
//         "records": {
//             "$push": "$$ROOT"
...
// db['suspected-carloschanta'].aggregate({ "$group": [{ '$group': { '_id': '$category', 'records': { '$push': '$$ROOT' }, 'count': { '$sum': 1 } } }] })



// a = { '$group': { '_id': '$category', 'records': { '$push': '$$ROOT' }, 'count': { '$sum': 1 } } }





db['suspected-carloschanta'].aggregate({ '$group': { '_id': '$category', 'records': { '$push': '$$ROOT' }, 'count': { '$sum': 1 } } }).pretty()
